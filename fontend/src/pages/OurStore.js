                ...
                <div className="d-flex justify-content-between align-items-center">
                  <div className="d-flex align-items-center gap-10">
                    ...
                    <select name="" className="form-control form-select" id="">
                      ...
                      <option value="title-acending">Alphabetically A-Z</option>
                      <option value="title-decending">
                        Alphabetically Z-A
                      </option>
                      <option value="price-acending">Price Low To High</option>
                      <option value="price-decending">Price High To Low</option>
                      <option value="created-acending">Date Old To New</option>
